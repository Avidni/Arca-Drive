...
import { Image, Upload, Search, Tags, Filter } from "lucide-react";
...
export default function ImagesPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (result === null) return; // step-up in progress
        ...
        <>
          ...
          <div className="fixed inset-y-0 left-0 z-50 w-64 border-r border-border bg-card p-4 overflow-y-auto lg:hidden">
            ...
            <div className="space-y-4">
              <div className="relative">
                <Search className="absolute left-2.5 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
                <Input placeholder="Search images" value={query} onChange={(e) => setQuery(e.target.value)} className="pl-8" />
              </div>
      ...
      <div className="flex-1 space-y-4 min-w-0">
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            title="No images stored yet."
            description="Upload your first image to start building your visual library."
            action={
